...
internal class Database(driverFactory: DatabaseDriverFactory) {
    ...
    fun insertMeal(meal: MealModel): Int { // This fun will return how many row is inserted
        val insertedRow = dbQuery.insertMeal(
        ...
        return insertedRow.value.toInt()
    }
    ...
    fun removeMeal(id: String): Int { // This fun will return how many row is deleted
        return dbQuery.removeMeal(id).value.toInt()
    }
}
...
private fun Meal.toModel(): MealModel {
    return MealModel(
        id, name, category,
        country, instructions, thumbnail,
